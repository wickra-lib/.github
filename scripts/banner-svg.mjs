...
export const LIBRARIES = [
  ...
  { name: 'wickra-darwin', layer: 'research', shipped: true },
  { name: 'wickra-gym', layer: 'research', shipped: true },
  { name: 'wickra-impact', layer: 'research', shipped: true },

  { name: 'wickra-verify', layer: 'trust', shipped: true },
  { name: 'wickra-proof', layer: 'trust', shipped: true },
  { name: 'wickra-zk', layer: 'trust', shipped: true },
